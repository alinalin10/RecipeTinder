...
const userSchema = new Schema({
    ...
    // relational data below
    userRecipes: [{ type: Schema.Types.ObjectId, ref: 'UserRecipes' }], // array of UserRecipes references
    savedRecipes: [{ type: Schema.Types.ObjectId, ref: 'UserRecipes' }], // array of latest 10 Recipe references
